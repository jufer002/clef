...
class CourseContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_content" do
    assert_difference('CourseContent.count') do
      post course_contents_url, params: { course_content: { course_id: @course_content.course_id, section_id: @course_content.section_id } }
    end
  ...
  test "should update course_content" do
    patch course_content_url(@course_content), params: { course_content: { course_id: @course_content.course_id, section_id: @course_content.section_id } }
